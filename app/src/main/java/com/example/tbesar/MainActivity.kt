...
class MainActivity : AppCompatActivity() {
    ...
    fun setUpBottomNav(){
        ...
        val bundle = Bundle()
        bundle.putString("nim", data.nim.toString())
        bundle.putString("nama", data.nama.toString())
        bundle.putString("jenis_kelamin", data.jenkel.toString())
        ...
        bundle.putString("prodi", data.prodi.toString())
        bundle.putString("angkatan", data.angkatan.toString())
